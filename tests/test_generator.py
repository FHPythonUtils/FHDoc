...
from fhdoc.generator import Generator, GeneratorError
from fhdoc.utils.import_string import ImportString


class TestGenerator(unittest.TestCase):
	@patch("fhdoc.generator.Loader")
	@patch("fhdoc.generator.ModuleRecordList")
	@patch("fhdoc.generator.MDDocument")
	@patch("fhdoc.generator.PathFinder")
	def test_init(
